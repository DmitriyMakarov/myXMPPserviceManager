information = {
    'info_text_EN': 'You can delete your account or change your password:',
    'info_text_RU': 'Вы можете удалить свою учетную запись или поменять пароль:',
    'no_info_text_EN': 'There is no account data in our database.\nif you are already logged in to our server, contact the assistant bot.\nIf not, register an account',
    'no_info_text_RU': 'В нашей БД отсутствуют данные об учетных записях.\nЕсли вы уже авторизованы на нашем сервере - обратитесь к боту помощнику.\nЕсли нет зарегистрируйте учетную запись',
    'main_about_EN': 'The bot allows you to get a login and password for a closed XMPP server, which allows you to communicate with a high level of encryption.\nYou can also delete your data inside the server at any time through this bot.\n\nLogin is formed randomly, so as not to be associated with the user`s personal data in any way, the password is resistant to hacking.\n\nWe recommend the following programs to ensure private communication:\nAndroid - <a href="https://f-droid.org/ru/packages/eu.siacs.conversations/">Conversation</a>\nIOS - <a href="https://apps.apple.com/ru/app/chatsecure/id464200063 ">ChatSecure Messenger</a>\n\n Learn more about setting up and encrypting in the Help section',
    'main_about_RU': 'Бот позволяет получить логин и пароль для закрытого XMPP сервера, позволяющего обеспечить общение с высоким уровнем шифрования.\nТакже вы можете в любой момент удалить свои данные внутри сервера через этот бот.\n\nЛогин сформирован случайным образом, что бы никак не быть ассоциированным с персональными данными пользователя, пароль устойчивый к взлому.\n\nМы рекомендуем следующие программы для обеспечения приватного общения:\nAndroid - <a href="https://f-droid.org/ru/packages/eu.siacs.conversations/">Conversation</a>\nIOS - <a href="https://apps.apple.com/ru/app/chatsecure/id464200063">ChatSecure Messenger</a>\n\nПодробнее о настройке и шифровании в разделе Помощь'
}
